...
- name: 茉莉花
  price: 50 元/公斤
  traits: 花型美观、芳香浓郁、花期较长、药用价值、茶叶原料
  synopsis: 茉莉花（学名： Jasminum sambac ），又称素馨花、茉莉子、茉莉花等，属于木犀科、茉莉属植物。原产于喜马拉雅山脉的印度北部和缅甸，后传入中国。茉莉花在中国有着悠久的栽培历史，被誉为“国花之一”，并被广泛应用于园林、香料、茶叶、药用等领域。
...
```

Contains only name, price, traits, synopsis (Use Chinese, no more than 20 words).
Generate 20 pieces of different floral data in YAML formats as in the example above.
""".strip()
...
if __name__ == '__main__':
    ...
    with open('data/json/flowers_info.json', 'w', encoding='utf-8') as f:
        f.write(json_str)


# 运行方法: `python3 data_generator/gen_flowers.py`
